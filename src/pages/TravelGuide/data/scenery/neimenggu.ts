...
export const neimengguData: SceneryData = {
  ...
  seasonal: [
    {
      name: '春季',
      description: '春暖花开,草原复苏,是欣赏草原春景的好时�?,
      image: 'https://picsum.photos/id/1200/600/400',
      activities: ['草原踏青', '阿尔山游�?, '成吉思汗陵参�?, '响沙湾探�?],
    },
    {
      name: '夏季',
      description: '绿草如茵,是草原最美的季节,适合草原旅游',
      image: 'https://picsum.photos/id/1200/600/400',
      activities: ['草原骑马', '阿尔山避�?, '呼伦贝尔草原�?, '满洲里旅�?],
    },
    {
      name: '秋季',
      description: '秋高气爽,额济纳胡杨林金黄一�?是摄影的最佳时�?,
      image: 'https://picsum.photos/id/1204/600/400',
      activities: ['额济纳胡杨林摄影', '草原秋游', '阿尔山秋�?, '成吉思汗陵参�?],
    },
    {
      name: '冬季',
  ...
  routes: [
    {
      ...
      name: '呼伦贝尔草原之旅',
      title: '呼伦贝尔草原之旅',
      description: '体验辽阔的草原风�?,
      duration: '3�?,
      difficulty: '中等',
      highlights: ['呼伦贝尔大草�?, '满洲�?],
      spots: ['呼伦贝尔大草�?, '满洲�?],
      tags: ['草原', '自然', '民族'],
      image: 'https://picsum.photos/id/1200/600/400',
      rating: 4.8,
...
export const neimengguIntangibleHeritage = [
  {
    id: '1',
    name: '蒙古族长�?,
    description: '蒙古族传统音�?被誉为草原音乐活化石',
    level: 'national',
    category: '传统音乐',
    protectionUnit: '内蒙古自治区艺术研究所',
    features: ['传统音乐', '国家级非�?, '草原文化'],
    icon: '🎵',
    image: 'https://picsum.photos/id/1200/600/400',
  },
];
...
export const neimengguFolkCustomsElements = [
  {
    name: '那达慕大�?,
    description: '蒙古族传统节�?盛大的草原盛�?,
    image: 'https://picsum.photos/id/1200/600/400',
    tags: ['传统节日', '草原文化', '蒙古�?, '民俗活动', '体育竞技'],
  },
];
