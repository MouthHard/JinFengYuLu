...
export const cultureDepthAnalysis: Record<string, string> = {
  forbiddenCity:
    "故宫是中国明清两代的皇家宫殿，是世界上现存规模最大、保存最为完整的木质结构古建筑之一。它不仅是中国古代宫廷建筑的精华，也是中国封建社会的象征，见证了明清两代的兴衰变迁。",
  greatWall:
    "长城是中国古代伟大的防御工程，是中华民族的象征。它不仅是军事防御体系的杰作，也是中国古代劳动人民智慧和勇气的结晶，是世界文化遗产中的瑰宝。",
  summerPalace:
    "颐和园是中国现存规模最大、保存最完整的皇家园林，被誉为皇家园林博物馆。它融合了中国传统园林艺术的精华，体现了'虽由人作，宛自天开'的造园理念。",
  templeOfHeaven:
    "天坛是明清两代皇帝祭天、祈求五谷丰登的场所，是中国古代祭祀建筑的杰出代表。它的建筑设计体现了中国古代'天人合一'的哲学思想，是世界文化遗产。",
  bund: "外滩是上海的标志性景观，拥有52栋风格各异的古典复兴大楼，是中国近现代重要史迹及代表性建筑。它见证了上海从一个小渔村发展成为国际大都市的历史变迁。",
  orientalPearl:
    "东方明珠是上海的标志性建筑之一，是上海的地标性建筑和旅游热点。它融合了现代建筑技术和中国传统建筑元素，成为上海现代化建设的象征。",
  yuGarden:
    "豫园是上海市区内唯一的江南古典园林，是上海的历史文化名片。它体现了江南园林的精巧雅致，是中国传统园林艺术的杰出代表。",
  cantonTower:
    "广州塔是广州的标志性建筑，是中国第一高塔。它融合了现代建筑技术和广州的地域文化特色，成为广州现代化建设的象征。",
  kaipingDiaolou:
    "开平碉楼是世界文化遗产，是中国乡土建筑的一个特殊类型。它融合了中国传统建筑和西方建筑元素，反映了侨乡文化的独特魅力。",
  chenClanAcademy:
    "陈家祠是广州传统建筑的代表作，以精湛的工艺著称。它集岭南地区民间建筑装饰艺术之大成，是研究岭南建筑艺术的重要实物资料。",
  wuzhen:
    "乌镇是中国首批十大历史文化名镇之一，典型的江南水乡古镇。它保存了完整的水乡古镇风貌，是江南水乡文化的杰出代表。",
  putuoMountain:
    "普陀山是中国佛教四大名山之一，是观世音菩萨的道场，素有'海天佛国'之称。它不仅是佛教圣地，也是著名的海岛风景名胜区。",
};

// 非物质文化遗产默认数据
export const defaultIntangibleHeritage: Record<
  string,
  IntangibleHeritageItem[]
> = {
  beijing: [
    {
      id: "1",
  ...
  beijing: [
    {
      ...
      name: "京剧",
      description:
        "中国国粹，集唱、念、做、打于一体的传统戏曲艺术。起源于清代乾隆年间，融合了徽剧、汉剧等多种戏曲元素，形成了独特的艺术风格。京剧脸谱色彩斑斓，服饰华丽精美，表演程式严谨规范，是中国传统文化的重要代表。",
    },
    {
      icon: "🎪",
      name: "庙会",
      description:
        "传统民俗活动，集宗教、娱乐、商业于一体。北京庙会历史悠久，最著名的有地坛庙会、龙潭庙会等。庙会期间，人们可以欣赏传统戏曲表演、民间艺术展示，品尝各种风味小吃，购买手工艺品，感受浓厚的节日氛围。",
    },
    {
      icon: "🏮",
      name: "灯会",
      description:
        "传统节庆活动，展示各种精美花灯。北京灯会以元宵节期间最为盛大，灯会上的花灯造型各异，有传统的宫廷灯、民间灯，也有现代创意灯。灯会还会举办猜灯谜、放烟花等活动，吸引众多游客参与。",
    },
    {
      icon: "🥟",
      name: "北京小吃",
      description:
        "豆汁、焦圈、炸酱面等传统美食。北京小吃历史悠久，品种繁多，具有独特的风味。豆汁是老北京的传统饮品，味道独特；焦圈外酥里嫩，是豆汁的绝佳搭配；炸酱面则以其浓郁的酱香和筋道的面条深受喜爱。",
    },
  ],
  shanghai: [
    {
      ...
      name: "沪剧",
      description:
        "上海地方戏曲，具有浓郁的江南特色。起源于清代道光年间，原名申曲，后改名为沪剧。沪剧语言通俗易懂，旋律优美动听，表演细腻真实，多反映现实生活题材，深受上海市民喜爱。",
    },
    {
      icon: "🎪",
      name: "豫园灯会",
      description:
        "上海传统节庆活动，历史悠久。豫园灯会始于清代，每年元宵节期间举办，是上海最具影响力的民俗活动之一。灯会上的花灯制作精美，主题丰富，融合了传统元素与现代科技，吸引了大量游客前来观赏。",
    },
    {
      icon: "🍲",
      name: "上海本帮菜",
      description:
        "浓油赤酱，口味醇厚的上海特色菜肴。上海本帮菜起源于清代，以红烧、清蒸、煨煮等烹饪方法为主，注重原汁原味，代表菜品有红烧肉、糖醋排骨、清蒸大闸蟹等，深受国内外食客喜爱。",
    },
    {
      icon: "🛶",
      name: "江南水乡",
      description:
        "周庄、乌镇等水乡古镇的民俗文化。江南水乡以其独特的水乡风光和深厚的文化底蕴闻名。古镇里小桥流水、粉墙黛瓦，居民依水而居，保留了许多传统的生活方式和民俗活动，如摇橹船、水乡婚礼、传统手工艺制作等。",
    },
  ],
  guangdong: [
    {
      ...
      name: "粤剧",
      description:
        "广东地方戏曲，唱腔优美，表演细腻。粤剧是广东文化的瑰宝，以其独特的唱腔和精湛的表演艺术闻名。粤剧的唱腔丰富多样，表演程式严谨，服装道具精美，是中国戏曲艺术的重要组成部分。",
    },
    {
      icon: "🦁",
      name: "醒狮",
      description:
        "广东传统民俗活动，象征吉祥如意。醒狮是广东最具代表性的民俗活动之一，通常在节日庆典、开业大吉等场合表演。醒狮表演动作矫健有力，寓意驱邪避凶、招财纳福，深受人们喜爱。",
    },
    {
      icon: "🥢",
      name: "粤菜",
      description:
        "中国八大菜系之一，以鲜、嫩、爽、滑著称。粤菜注重食材的新鲜和原味，烹饪方法多样，讲究火候和调味。代表菜品有烧鹅、白切鸡、清蒸石斑鱼等，深受国内外食客喜爱。",
    },
    {
      icon: "🚣",
      name: "龙舟竞渡",
      description:
        "端午节传统活动，象征团结拼搏。龙舟竞渡是广东端午节的重要习俗，人们通过赛龙舟纪念屈原，同时也展现了团结协作、奋勇争先的精神。比赛现场锣鼓喧天，热闹非凡，吸引众多观众前来观看。",
    },
  ],
  zhejiang: [
    {
      ...
      name: "越剧",
      description:
        "浙江地方戏曲，委婉细腻，优美动听。越剧起源于浙江嵊州，是中国第二大剧种。越剧以其委婉的唱腔、细腻的表演和优美的舞台艺术著称，多以爱情故事为题材，深受观众喜爱。",
    },
    {
      icon: "🍵",
      name: "茶文化",
      description:
        "西湖龙井等名茶的种植、采摘和品饮文化。浙江是中国重要的产茶区，西湖龙井更是中国十大名茶之一。浙江的茶文化历史悠久，包括茶叶的种植、采摘、制作和品饮等环节，形成了独特的茶文化体系。",
    },
    {
      icon: "🏯",
      name: "水乡古镇",
      description:
        "乌镇、西塘等保存完好的江南水乡古镇。浙江拥有众多水乡古镇，这些古镇保存了完整的江南水乡风貌和传统文化。古镇里河道纵横，石桥遍布，古建筑鳞次栉比，是了解江南水乡文化的重要窗口。",
    },
    {
      icon: "🧵",
      name: "丝绸文化",
      description:
        "杭州丝绸的生产历史和工艺传承。浙江是中国丝绸的重要产地，杭州丝绸以其质地柔软、色彩鲜艳、图案精美著称。丝绸文化包括蚕桑养殖、丝绸制作工艺和丝绸制品的使用等方面，是浙江传统文化的重要组成部分。",
    },
  ],
};
  ...
  beijing: {
    ...
    seasonal: [
      ...
      },
      {
        name: "秋季",
        description:
          "秋高气爽，香山红叶满山，八达岭长城红叶漫天，是观赏红叶的最佳季节",
    ...
    seasonal: [
      {
        name: "春季",
        description:
          "春暖花开，豫园樱花盛开，外滩春意盎然，是游览江南园林的最佳时节",
      ...
      },
      {
        name: "夏季",
        description:
          "夏季炎热，黄浦江夜游凉爽，迪士尼水上乐园开放，适合夜游和室内活动",
