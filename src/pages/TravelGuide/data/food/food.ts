import type { FoodItem, FoodLocation } from '@/types/travelGuide';
  ...
  tianjin: [
    {
      ...
      foods: ["goubuli", "ear-hole-fried-cake", "十八街麻�?],
      reason: "天津传统美食集中�?,
    },
    {
      id: 2,
