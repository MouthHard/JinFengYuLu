...
// 导出展览分类和静态数�?export { exhibitionCategories, staticExhibitions } from "./exhibitionData";
...
export const exhibitions: Exhibition[] = [
  // 故宫博物院展�?  {
    ...
    museumId: 1,
    title: "紫禁城建�?00年展",
    description: "庆祝紫禁城建�?00周年，展示故宫的历史与文化�?,
    date: "2020�?�?- 2021�?�?,
    image:
