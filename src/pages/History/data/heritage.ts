...
export const culturalHeritage: CulturalHeritageItem[] = [
  {
    ...
    era: "春秋战国-明",
    year: "公元前7世纪-公元17世纪",
    brief: "中国古代伟大的防御工程，世界文化遗产。",
    description:
      "长城是中国古代伟大的防御工程，也是世界上最伟大的建筑之一。长城始建于春秋战国时期，秦统一六国后，秦始皇将各国的长城连接起来，形成了万里长城。此后，历代王朝都对长城进行了修缮和扩建。长城的主要作用是防御北方游牧民族的入侵，它是中国古代劳动人民智慧和勇气的结晶。1987年，长城被联合国教科文组织列为世界文化遗产。",
    history:
    ...
    culturalSignificance:
      "长城是中华民族的象征，也是人类文明史上最伟大的建筑工程之一。它体现了中国古代人民的智慧、勇气和毅力，是中国历史文化的重要载体。",
    features: [
      "世界上最长的防御工程",
      "中国古代劳动人民智慧和勇气的结晶",
      "中国古代军事防御体系的重要组成部分",
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    images: [
      "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1587790890044-4a665722283e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1587790890044-4a665722283e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    images: [
      "https://images.unsplash.com/photo-1587790890044-4a665722283e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1586348943529-beaae6c28db9?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    images: [
      "https://images.unsplash.com/photo-1586348943529-beaae6c28db9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    history:
      "布达拉宫依山垒砌，群楼重叠，殿宇嵯峨，气势雄伟，有横空出世、气贯苍穹之势，坚实墩厚的花岗石墙体，松茸平展的白玛草墙领，金碧辉煌的金顶，具有强烈装饰效果的巨大鎏金宝瓶、经幢和红幡，交相映辉。",
    culturalSignificance:
      "布达拉宫是藏式建筑的杰出代表，也是中华民族古建筑的精华之作。它是藏传佛教的重要圣地，也是藏汉文化交流的历史见证。",
    features: [
      "世界上海拔最高、规模最大的宫堡式建筑群",
      "藏传佛教圣地",
      "藏式建筑的杰出代表",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1593941707431-f326c02f3f54?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1593941707431-f326c02f3f54?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    images: [
      "https://images.unsplash.com/photo-1593941707431-f326c02f3f54?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    images: [
      "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    brief: "中国古代水利工程，世界文化遗产。",
    description:
      "都江堰，位于四川省成都市都江堰市城西，是中国古代伟大的水利工程，也是世界上现存最古老、至今仍在使用的水利工程之一。都江堰始建于战国时期秦昭王末年（约公元前256年-前251年），由秦国蜀郡太守李冰父子主持修建。",
    history:
      "都江堰位于四川省成都市都江堰市城西，坐落在成都平原西部的岷江上，始建于秦昭王末年（约公元前256年-前251年），是蜀郡太守李冰父子在前人鳖灵开凿的基础上组织修建的大型水利工程。",
    culturalSignificance:
      '都江堰的修建，解决了岷江水患，灌溉了成都平原，使成都平原成为"天府之国"。它体现了中国古代劳动人民的智慧和勇气。',
    features: [
      "世界上现存最古老、至今仍在使用的水利工程之一",
      "解决了岷江水患，灌溉了成都平原",
      "体现了中国古代劳动人民的智慧和勇气",
      "世界文化遗产",
    ],
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1584539610135-2a2f2286f064?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1584539610135-2a2f2286f064?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    images: [
      "https://images.unsplash.com/photo-1584539610135-2a2f2286f064?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    history:
      '黄山原名"黟山"，因峰岩青黑，遥望苍黛而名。后因传说轩辕黄帝曾在此炼丹，故改名为"黄山"。黄山代表景观有"五绝三瀑"，五绝：奇松、怪石、云海、温泉、冬雪；三瀑：人字瀑、百丈泉、九龙瀑。',
    culturalSignificance:
