...
export const liaoningData: SceneryData = {
  ...
  seasonal: [
    {
      name: '春季',
      description: '春暖花开,千山山花烂漫,是踏青赏花的好时�?,
      image: 'https://picsum.photos/id/1223/600/400',
      activities: ['千山踏青', '沈阳故宫游览', '大连海滨漫步', '北陵公园赏花'],
    },
    {
      name: '夏季',
      description: '绿树成荫,大连海滨是避暑纳凉的好去�?,
      image: 'https://picsum.photos/id/1221/600/400',
      activities: ['大连海滨度假', '金石滩游�?, '老虎滩海洋公�?, '星海广场纳凉'],
    },
    {
      name: '秋季',
      description: '秋高气爽,千山红叶满山,是登山赏秋的好时�?,
      image: 'https://picsum.photos/id/1223/600/400',
  ...
  routes: [
    {
      ...
      name: '大连海滨之旅',
      title: '大连海滨之旅',
      description: '体验美丽的海滨风�?,
      duration: '2�?,
      difficulty: '简�?,
      highlights: ['大连金石�?, '老虎滩海洋公�?, '星海广场'],
      spots: ['大连金石�?, '老虎滩海洋公�?, '星海广场'],
      tags: ['海滨', '度假', '休闲'],
      image: 'https://picsum.photos/id/1221/600/400',
      rating: 4.6,
      bestTime: '夏季',
...
export const liaoningIntangibleHeritage = [
  {
    id: '1',
    name: '东北二人�?,
    description: '东北地方戏曲,具有浓郁的地方特�?,
    level: 'national',
    category: '传统戏剧',
    protectionUnit: '辽宁省艺术研究院',
    features: ['传统戏剧', '国家级非�?, '东北文化'],
    icon: '🎭',
    image: 'https://picsum.photos/id/1220/600/400',
  },
];
