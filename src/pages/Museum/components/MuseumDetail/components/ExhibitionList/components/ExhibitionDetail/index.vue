<template>
  <div class="exhibition-detail" v-if="selectedExhibition">
    <!-- 展览标题、图片和操作按钮 -->
    ...
    <!-- 展览概览内容 -->
    <div class="detail-content" v-if="activeTab === 'overview'">
      <!-- 展览简介 -->
      ...
      <div class="content-section">
        ...
        <div class="info-grid">
          ...
          <div class="info-item" v-if="(selectedExhibition as any).curator">
            <span class="info-label">策展人：</span>
            <span class="info-value">{{
              (selectedExhibition as any).curator
            }}</span>
          </div>
          <div class="info-item" v-if="(selectedExhibition as any).scale">
            <span class="info-label">展览规模：</span>
            <span class="info-value">{{
              (selectedExhibition as any).scale
            }}</span>
          </div>
          <div class="info-item" v-if="(selectedExhibition as any).visitors">
    ...
    <!-- 展品欣赏内容 -->
    <div class="detail-content" v-if="activeTab === 'exhibits'">
      <div class="content-section">
        <h4 class="section-title">展品欣赏</h4>
        <div class="exhibits-masonry">
          <div class="exhibit-item" v-for="i in 6" :key="i">
            <div class="exhibit-image" :class="`size-${(i % 3) + 1}`">
              <img :src="selectedExhibition.image" :alt="`展品 ${i}`" />
            </div>
    ...
    <!-- 历史背景内容 -->
    <div class="detail-content" v-if="activeTab === 'history'">
      <div class="content-section">
  ...
  <div class="exhibition-detail-empty" v-else>
