<template>
  <div class="heritage-detail">
    <!-- 右侧云纹装饰 -->
    <div class="cloud-pattern right"></div>
      ...
      <div class="detail-header">
        ...
        <div class="meta-row">
          ...
          <span class="meta-item period">
            <i class="icon-year"></i> {{ selectedHeritage.year }}
          </span>
          <span class="meta-item location">
            <i class="icon-location"></i> {{ selectedHeritage.location }}
          </span>
        </div>
      </div>
      ...
      <div class="detail-sections">
        ...
        <section class="detail-section">
          ...
          <ul class="highlight-list">
            <li
              v-for="(highlight, index) in selectedHeritage.features"
              :key="index"
            >
              {{ highlight }}
            </li>
        ...
        >
          ...
          <div class="related-figures-list">
            <span
              v-for="(figure, index) in selectedHeritage.relatedFigures"
              :key="index"
              class="figure-tag"
            >
              {{ figure }}
        ...
        <section
          class="detail-section"
          v-if="selectedHeritage.images && selectedHeritage.images.length > 0"
        >
          ...
          <div class="image-gallery">
            ...
            >
              <img
                :src="image"
                :alt="selectedHeritage.name + ' - ' + (index + 1)"
                class="gallery-image"
              />
            </div>
          </div>
        ...
        <section class="detail-section">
          ...
          <div class="related-heritage-list">
            <div
              v-for="relatedItem in relatedHeritage"
              :key="relatedItem.id"
              class="related-heritage-card"
            >
              <img
                :src="relatedItem.thumbnailUrl"
                :alt="relatedItem.name"
                class="related-heritage-image"
              />
