        ...
        <thead>
          <tr>
            ...
            <th @click="cycleSortLabel(0)">
              标题
              <h5>{{ SORT_LABELS[0].arr[sortIndices[0]] }}</h5>
            </th>
            <th @click="cycleSortLabel(1)">
              专辑
              <h5>{{ SORT_LABELS[1].arr[sortIndices[1]] }}</h5>
            </th>
            <th>喜欢</th>
            <th @click="cycleSortLabel(2)">
              时长
              <h5>{{ SORT_LABELS[2].arr[sortIndices[2]] }}</h5>
            </th>
          </tr>
        </thead>
        <tbody>
...
import type { SongItem } from "@/types/music/music";

const active = ref(0);
const sortIndices = ref([0, 0, 0]);
const hoveredRowId = ref<number | null>(null);
const likeSongArr = ref<SongItem[]>([...DEFAULT_LIKE_SONGS]);
const commentArr = ref([...DEFAULT_COMMENTS]);
const collectorArr = ref([...DEFAULT_COLLECTORS]);
