...
const hubeiNatureSpots: ScenerySpot[] = [
  {
    ...
    name: "武当山",
    description:
      "湖北省十堰市的著名山脉，以其壮丽的自然风光和丰富的道教文化而闻名",
  ...
  },
  {
    ...
    name: "三峡",
    description:
      "湖北省宜昌市的著名峡谷，以其壮丽的自然风光和宏伟的水利工程而闻名",
  ...
  },
  {
    ...
    name: "宜昌三峡大坝",
    description:
      "湖北省宜昌市的著名水利工程，以其宏伟的建筑和丰富的历史文化而闻名",
  ...
  },
  {
    ...
    name: "恩施大峡谷",
    description:
      "湖北省恩施土家族苗族自治州的著名峡谷，以其壮丽的自然风光和独特的地质景观而闻名",
  ...
  },
  {
    ...
    name: "洞庭湖",
    description:
      "湖北省荆州市的著名湖泊，以其美丽的自然风光和丰富的生态资源而闻名",
  ...
  },
  {
    ...
    name: "神农架",
    description:
      "湖北省神农架林区的著名自然保护区，以其丰富的生物多样性和壮丽的自然风光而闻名",
...
const hubeiCultureSpots: ScenerySpot[] = [
  ...
  },
  {
    ...
    name: "宜昌清江画廊",
    description:
      "湖北省宜昌市的著名景区，以其美丽的自然风光和丰富的民俗文化而闻名",
  ...
  },
  {
    ...
    name: "武当山道教建筑群",
    description:
      "湖北省十堰市的著名道教建筑群，以其宏伟的建筑和丰富的道教文化而闻名",
  ...
  },
  {
    ...
    name: "黄冈东坡赤壁",
    description:
      "湖北省黄冈市的著名历史遗址，以其丰富的历史文化和优美的自然风光而闻名",
...
const hubeiSeasonalData: Record<string, SeasonalScenery> = {
  ...
  winter: {
    name: "冬季",
    description:
      "冬季的湖北，虽然寒冷，但神农架雪景令人惊叹，是参观武汉博物馆的好时节",
...
const hubeiIntangibleHeritage = [
  ...
  },
  {
    ...
    name: "土家族摆手舞",
    description:
      "湖北省恩施土家族苗族自治州传统舞蹈，以其独特的表演形式和丰富的内容著称",
    level: "national",
    category: "传统舞蹈",
    heritageType: "传统表演艺术",
  ...
  overview: {
    ...
    topAttractions: [
      ...
      },
      {
        ...
        image: "https://picsum.photos/id/1036/600/400",
        description:
          "湖北省武汉市的著名楼阁，以其宏伟的建筑和丰富的历史文化而闻名",
      },
      {
        name: "恩施大峡谷",
        image: "https://picsum.photos/id/1038/600/400",
...
export const hubeiCustomsData = {
  activities: [
    ...
    },
    {
      ...
      name: "楚剧表演欣赏",
      description:
        "欣赏湖北省传统戏曲艺术楚剧表演，感受其独特的表演形式和丰富的内容",
    ...
    },
    {
      ...
      name: "土家族摆手舞体验",
      description:
        "学习湖北省恩施土家族苗族自治州传统舞蹈摆手舞，体验其独特的魅力",
